...
public class Main extends Application{
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        try{
            ...
            System.out.println("Cannot connect: Offline mode");
        }
        ...
        createLoginButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (success){
                    ...
                    showAlert(Alert.AlertType.ERROR, logInScene().getWindow(), "Login Failure", "Please Check Username & Password");
                }
        ...
        submitButton.setOnAction(new EventHandler<ActionEvent>(){
            public void handle(ActionEvent t){
                ...
                if (success){
                    ...
                    showAlert(Alert.AlertType.ERROR, gridPaneRegister.getScene().getWindow(), "Registration Failure", "No more detailed info at this time");
                }
            }
        });
